...
var px = function(t) {
  ...
  , random = function(t, e) {
    return t && "number" == typeof t.length ? t[Math.floor(Math.random() * t.length)] : ("number" != typeof e && (e = t || 1,
    t = 0),
    t + Math.random() * (e - t))
};
...
TinyHeart.prototype = {
    ...
    draw: function() {
        var t = this.img;
        t || (t = document.createElement("img"),
        t.src = "img/" + this.style + ".png",
...
var shakes = {
    ...
    update: function() {
        var t, e;
        for (t = shakes.pool.length - 1; t >= 0; t--)
            e = shakes.pool[t],
            e.alive ? e.move() : (e.destory(),
            shakes.pool.splice(t, 1))
    },
    stop: function() {
